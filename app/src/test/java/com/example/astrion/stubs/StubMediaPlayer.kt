...
import com.example.astrion.esphome.mediaplayer.MediaMetadata
import com.example.astrion.esphome.mediaplayer.MediaPlayer
...
open class StubMediaPlayer(
    ...
    override val metadata: StateFlow<MediaMetadata> = MutableStateFlow(MediaMetadata()),
