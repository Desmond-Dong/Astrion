...
import com.example.astrion.notifications.createVoiceSatelliteServiceNotification
import com.example.astrion.notifications.createVoiceSatelliteServiceNotificationChannel
import com.example.astrion.nsd.NsdRegistration
import com.example.astrion.nsd.registerVoiceSatelliteNsd
import com.example.astrion.settings.VoiceSatelliteSettings
import com.example.astrion.settings.VoiceSatelliteSettingsStore
import com.example.astrion.tasker.observeTaskerState
import com.example.astrion.utils.setTrustAllSSLCertificates
import com.example.astrion.utils.translate
...
class VoiceSatelliteService() : LifecycleService() {
    ...
    @Inject
    lateinit var panelConfigStore: com.example.astrion.panel.PanelConfigStore
