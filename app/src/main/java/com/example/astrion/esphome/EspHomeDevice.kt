package com.example.astrion.esphome

import android.Manifest
import androidx.annotation.RequiresPermission
import com.example.astrion.esphome.entities.Entity
import com.example.astrion.esphome.logger.Logger
import com.example.astrion.esphome.voiceassistant.VoiceAssistant
import com.example.astrion.server.DEFAULT_SERVER_PORT
import com.example.astrion.server.Server
import com.example.astrion.server.ServerException
...
class EspHomeDevice(
    ...
    /**
     * Closes the current ESPHome connection. The Home Assistant client will
     * reconnect automatically and re-request the entity list, which is how
     * entity state and entity changes are refreshed.
     */
